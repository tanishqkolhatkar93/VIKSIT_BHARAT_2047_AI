...
This data package contains the data that powers the chart ["CO₂ emissions per capita"](https://ourworldindata.org/explorers/co2?hideControls=false&Gas+or+warming=CO%E2%82%82&Accounting=Territorial&Fuel+or+land+use+change=All+fossil+emissions&Count=Per+capita&Relative+to+world+total=false&country=CHN~USA~IND~GBR~OWID_WRL) on the Our World in Data website. It was downloaded on August 11, 2026.
